                                    ...
                                    while($rows=mysqli_fetch_assoc($res))
                                    {
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo $featured_blog ?></td>
                                                <td class="text-center"><?php echo $active_blog ?></td>
                                                <td>
                                                    <div class="ROW flex pl-5 items-center gap-5">
                                                        <a href="<?php echo SITEURL_ADMIN; ?>update_blog.php?id=<?php echo $id; ?>">
                                                            <p class="BTN_SEC">Update Blog</p>
                                                        </a>
                                                        <a href="<?php echo SITEURL_ADMIN; ?>delete_blog.php?id=<?php echo $id; ?>&backgroundName=<?php echo $backgroundName ?>">
                                                            <p class="BTN_DAN">Delete Blog</p>
                                                        </a>
                                                    </div>
                                                </td>
                                            </tr>
